    ...
    def execute(self):
        ...
        try:
            ...
            if self.input_type==1:
                ...
                layer_wise_feature_extractor_S1 = init_dcva_model(self.args.model_s1_dir,self.vector_layer_list,self.args.ssl)
                pre_change_image_1 = read_image(self.args.pre_s1_path,input_type=self.input_type,top_saturate=self.top_saturate)
                post_change_image_1 = read_image(self.args.post_s1_path,input_type=self.input_type,top_saturate=self.top_saturate)
        ...
        steps = np.arange(0.0*otsuThreshold, np.max(distance_from_damaged_class_matrix), (np.max(distance_from_damaged_class_matrix)-0.0 * otsuThreshold) / self.args.threshold_steps)
