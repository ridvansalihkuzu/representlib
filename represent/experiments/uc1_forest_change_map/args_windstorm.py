...
class ArgumentsDCVA():
    ...
    def initialize(self, parser):
        ...
        # MANDATORY INPUTS
        parser.add_argument('--pre-s1-path',default="represent/data/UC1/windstorm_damage/S1/S1B_IW_GRDH_1SDV_20210601.tif",help='path to the pre-change image')
        parser.add_argument('--post-s1-path',default="represent/data/UC1/windstorm_damage/S1/S1B_IW_GRDH_1SDV_20210707.tif",help='path to the post-change image')
        ...
        parser.add_argument('--forest-mask-path', default="represent/data/UC1/windstorm_damage/GT/forest_mask.tif",help='path to the forest mask image')
        parser.add_argument('--ground-truth-path',default="represent/data/UC1/windstorm_damage/GT/damaged_stands_extended_set_area.tif",help='path to the reference ground-truth image')
        parser.add_argument('--input-type', type=int, default=2, help=' Input Type: 1 for S1, 2 for S2, 3 for S1 + S2')

        parser.add_argument('--out-dir',default='represent/result/windstorm/',type=str, help='Out Directory (default: represent/result/)')
        ...
        parser.add_argument('--object-min-size', type=int, nargs='+', default=[19],help='Minimum size for objects in pixel')
        parser.add_argument('--morphology-size', type=int, nargs='+', default=[23],help='Morphological operation size for image post-processing')
