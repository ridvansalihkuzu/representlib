...
from represent.experiments.uc1_forest_change_map.args_snowdamage import ArgumentsDCVA
from represent.experiments.uc1_forest_change_map.dcva_snowdamage import DeepChangeVectorAnalysis
import numpy as np
...
def main(args):
    ...
    def objective(trial):
        ...
        area = np.trapz(result_table.to_numpy()[:, 1], x=1-result_table.to_numpy()[:, 2])
