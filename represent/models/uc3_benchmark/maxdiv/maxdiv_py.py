...
def maxdiv_gp(X, intervals, mode = 'I_OMEGA', theta = 30, train_step = 5, **kwargs):
    ...
    if theta is None:
        gp = GaussianProcessRegressor(ConstantKernel(constant_value=1.0, constant_value_bounds=(1e-05, 100000.0)))
    else:
        gp = GaussianProcessRegressor(ConstantKernel(constant_value=theta, constant_value_bounds=(1e-05, 100000.0)))
